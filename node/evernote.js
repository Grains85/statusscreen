var callbackUrl = "http://localhost:9800/oauth_callback"; // your endpoint
...
module.exports = {
    getNotes: function(callback) {
        ...
        client.getRequestToken(callbackUrl, function(error, oauthToken, oauthTokenSecret) {
            if (error) {
                console.log("Error: Evernote: getRequestToken(): statusCode: " + error.statusCode);
                return;
            }
            ...
            */
            ...
            client.getAccessToken(oauthToken,
                ...
                function(error, oToken, oTokenSecret, results) {
                    if (error) {
                        console.log("Error: Evernote: getAccessToken(): statusCode: " + error.statusCode);
                        return;
                    }
